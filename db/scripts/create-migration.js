...
async function main() {
  ...
  const upContent = await ask('Up migration content? (Press enter to skip and add this later.)');
  const downContent = upContent ? await ask('Down migration content? (Press enter to skip and add this later.)') : '';
